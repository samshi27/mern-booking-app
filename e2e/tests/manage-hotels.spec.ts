...
// run the following test before each test case
test.beforeEach(async ({ page }) => {
  ...
  await page.locator("[name=email]").fill("test_register_20781@test.com");
...
test("should allow user to add a hotel", async ({ page }) => {
  ...
  await page
    ...
    .fill("This is a description fo the Test Hotel");
  ...
  await page.setInputFiles('[name="imageFiles"]', [
    ...
    path.join(__dirname, "files", "pexels-andrea-davis-14369630.jpg"),
  ]);
